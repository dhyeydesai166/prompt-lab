...
Route the message above. Return only JSON matching TriageOutput with keys
queue, escalation_required, confidence, rationale, draft_reply,
human_review_required, and customer_outcome. Do not add an analysis field.
